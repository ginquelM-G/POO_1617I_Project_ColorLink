 ...
 */
public class InvertPieceView extends PieceView {
    ...
    void paintPiece(int line, int col, Piece piece) {
        ...
        System.out.println("Class InvertPieceView -> paintPiece()  ");
        ...
        for (int i = line; i < line + PIECE_SIZE; i++) {
            for (int j = col; j < col + PIECE_SIZE; j++) {
                ...
                if (i == line + 1 && j == col + 1) Console.print(getViewType());
                    ...
                    else if (i % 3 == 1 && j % 3 == 2) Console.print('-');
                    else if (i % 3 == 0 &&  j% 3 == 2){
                    ...
                    if (i % 3 == 2 && j % 3 == 1) Console.print('|');
                    else if (i % 3 == 1 && j % 3 == 0) Console.print('-');
                    else if(i % 3==2 &&  j%3 ==0){
                        Console.color(Console.BLACK, Console.BLACK);
                        Console.print(' ');
                    }else Console.print(' ');
