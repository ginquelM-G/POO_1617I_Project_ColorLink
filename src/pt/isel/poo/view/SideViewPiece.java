 ...
 */
public class SideViewPiece extends ViewPiece {
        ...
        for (int i = line; i < line + 3; i++) {
            for (int j = col; j < col + 3; j++) {
                ...
                if (i == line + 1 && j == col + 1) Console.print(getViewType());
                    ...
                    if (d == Cell.Direction.UP || d == Cell.Direction.DOWN) {
                        if (i % 3 == 1 && (j % 3 == 0 || j % 3 == 2)) Console.print('-');

                        if (d == Cell.Direction.UP && i % 3 == 2) {
                            Console.color(Console.BLACK, Console.BLACK);
                            Console.print(' ');
                        } else if(d == Cell.Direction.UP && i%3 ==0){
                            Console.color(Console.WHITE, CELL_COLORS[model.cells[idxLine][idxCol].getColor()]);
                            Console.print(' ');
                        }
                        else if (d == Cell.Direction.DOWN && i % 3 == 0) {
                            Console.color(Console.BLACK, Console.BLACK);
                            Console.print(' ');
                        }else if (d== Cell.Direction.DOWN && i %3==2) {
                            Console.color(Console.WHITE, CELL_COLORS[model.cells[idxLine][idxCol].getColor()]);
                            Console.print(' ');
                        }

                    }
                    if (d == Cell.Direction.RIGHT || d == Cell.Direction.LEFT) {
                        if ((i % 3 == 0 || i % 3 == 2) && j % 3 == 1) Console.print('|');

                        if (d == Cell.Direction.RIGHT && j % 3 == 0) {
                            Console.color(Console.BLACK, Console.BLACK);
                            Console.print(' ');
                        } else if(d == Cell.Direction.RIGHT && j % 3 == 2 ) {
                            Console.color(Console.WHITE, CELL_COLORS[model.cells[idxLine][idxCol].getColor()]);
                            Console.print(' ');
                        }else if (d == Cell.Direction.LEFT && j % 3 == 2) {
                            Console.color(Console.BLACK, Console.BLACK);
                            Console.print(' ');
                        }else if(d == Cell.Direction.LEFT && j % 3 == 0 ){
                            Console.color(Console.WHITE, CELL_COLORS[model.cells[idxLine][idxCol].getColor()]);
                            Console.print(' ');
                        }
                    }
